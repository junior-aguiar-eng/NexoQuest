...
- [ ] **Fase 1** — Guardrails do projeto (`AGENTS.md`, `ARCHITECTURE.md`, `TEST_MATRIX.md`, etc.)
- [ ] **Fase 2** — Substituição visual mínima do GameRuntime (`QuestionPlayer`)
- [ ] **Fase 3** — Contratos de domínio + Zod
